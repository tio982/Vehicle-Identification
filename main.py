...
def main():
    ...
    criterion_xent = criterion_xent.to(device)
    criterion_htri = TripletLoss(margin=args.margin)
    criterion_htri = criterion_htri.to(device)
    ...
    if args.fixbase_epoch > 0:
        ...
        for epoch in range(args.fixbase_epoch):
            train(epoch, model, criterion_xent, criterion_htri, optimizer, trainloader, device, fixbase=True)
...
def train(
    epoch, model, criterion_xent, criterion_htri, optimizer, trainloader, device
):
